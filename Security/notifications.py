...
from Security.configs import SMTP_SERVER, SMTP_PORT, SMTP_EMAIL, SMTP_PASSWORD
...
If you did not request this reset, please contact support via this addresse : "belbaraka.adam@ensam-casa.ma".
