import time
from Security.user_data_manager import get_user, update_user
from Security.password import verify_password
from Security.notifications import send_warning_email
from Security.configs import (
    MAX_LOGIN_ATTEMPTS,
    DELAY_AFTER_3,
    DELAY_AFTER_4,
    DELAY_AFTER_5,
...
def verify_user_credentials(username: str, password: str):
    ...
    # Connexion OK, reset des flags eventuels
